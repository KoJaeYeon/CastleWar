...
public class DatabaseManager : MonoBehaviour
{
    ...
    public void ReadDataManually()
    {
        ...
        unitDataDic.Add(-2, new UnitData(-2, "성소", 75, UnitType.Building, 4125, 0, 0, 0, 0, UnitType.Ground, 0, CardType.Common,0));
        unitDataDic.Add(-1, new UnitData(-1, "막사", 50, UnitType.Building, 2750, 0, 0, 0, 0, UnitType.Ground, 0, CardType.Common,0));
        ...
        unitDataDic.Add(18, new UnitData(18, "소총 아울베어", 45, UnitType.Ground, 925, 237, 2.3f, 7, 3, UnitType.Both, 4, CardType.Rare, 30));
